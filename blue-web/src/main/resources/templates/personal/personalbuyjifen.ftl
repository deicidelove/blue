...
<body>
    ...
    <ul class="infor_ul">
        <li class="infor_li">
            ...
            <div class="left infor_li_input"><input type="text" value="" placeholder="请输入购买积分数量"></div>
        </li>
        <li class="infor_li">
            <div class="left infor_li_div">应付金额</div>
            <div class="left infor_li_input infor_li_input_color">￥0.00</div>
        </li>
    </ul>
    <p class="jifen_tip btn_bspace">购买需知：一元等于十个积分，积分只可兑换活动，不可再次转换成现金，且不可提取。解释权规南京蓝鲟口腔医院。</p>
    <div class="jifen_field">
        <button class="com_btn blue_btn">立即购买</button>
    </div>
</body>
</html>