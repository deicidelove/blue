...
public class DoctorController {
	...
	Result<Integer> delete(@PathVariable Integer id) {
	 ...
	 @RequestMapping(value = "update",method = RequestMethod.POST)
	    public @ResponseBody Result<Integer> update(@RequestParam("fileName") MultipartFile file,String name, int deptId,int sex,String phone, int sid,String introduce,String jobNum,String positionName,String address){	       
	        return doctorService.updateDoctor(file,name, deptId, sex, phone, 18, sid,introduce,jobNum,address,positionName);
	    }
