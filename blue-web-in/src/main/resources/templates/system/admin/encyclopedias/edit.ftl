<script type="text/javascript">
		var textStr;
		$("#encyclopediasTarget").load(function(){
		     debugger;
			 textStr=$(this);
...
<div class="row">
	<iframe id="encyclopediasTarget" name="encyclopediasTarget" style="display:none"></iframe>
    <div class="col-md-12">
        <form id="encyclopediasEditForm" method="post" enctype="multipart/form-data" action="/encyclopedias/update" target="encyclopediasTarget">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <select name="type" class="form-control select2" style="width: 100%;">
                        <option <#if bean.type == 0>selected="selected"</#if> value="0">口腔百科</option>
                        <option <#if bean.type == 1>selected="selected"</#if> value="1">精选百科</option>
                    </select>
                </div>
                <div class="form-group">
