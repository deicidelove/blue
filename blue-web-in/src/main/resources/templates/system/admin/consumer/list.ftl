	...
	<div class="col-xs-12">
		<div class="box">
			...
			<div class="box-body">
				...
				<table id="consumer_tab" class="table table-bordered table-striped">
					<thead>
						<tr>
							<tr>
								<th>序号</th>
...
$(function() {
	...
	var No=0;
	$('#consumer_tab').dataTable().fnDestroy();
	consumer_tab=$('#consumer_tab').DataTable({
		"dom":'itflp',
		"processing":true,
		"searching":false,
...
//					debugger;
	...
	$("#securitySeek").on("click",function(){
 		reloadTable(consumer_tab,"#securityTime","#securityPremise");
	});
});
